        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h2 className="mt-3 font-serif text-3xl font-semibold text-navy sm:text-4xl">
              Mitra Hukum untuk Pertumbuhan Bisnis Anda
            </h2>
            <p className="mt-6 leading-relaxed text-muted">
              Didirikan pada tahun 2008 di Jakarta, {company.fullName} telah
              berkembang menjadi firma hukum boutique dengan jaringan koresponden di
              lima kota besar Indonesia. Kami melayani klien mulai dari startup
              teknologi, grup konglomerat, hingga individu dalam urusan perdata dan
              pidana ekonomi.
            </p>
            <p className="mt-4 leading-relaxed text-muted">
              Pendekatan kami menggabungkan analisis hukum yang mendalam dengan
              pemahaman bisnis — sehingga setiap rekomendasi tidak hanya patuh
              regulasi, tetapi juga mendukung tujuan strategis klien.
            </p>
